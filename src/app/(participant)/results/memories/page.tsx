...
export default function MemoriesPage() {
  ...
  return <div className="participant-race-day min-h-full bg-[#f6f8fb] text-[#10233f]"><div className="mx-auto w-full max-w-[1240px] px-5 pb-12 pt-7 sm:px-7 lg:px-10 lg:pb-14 lg:pt-9">
    ...
    <section className="mt-7" aria-label="Available memory cards">{loading ? <div role="status" className="flex min-h-[260px] items-center justify-center"><span className="h-6 w-6 animate-spin rounded-full border-2 border-[#2563eb] border-t-transparent" /><span className="sr-only">Loading memory cards</span></div> : <MemoryCardStudio profile={profile} registration={registration} />}</section>
